...
pub(crate) struct DiffState {
    ...
    pub(crate) branch_status_auto_next_at: Option<Instant>,
    pub(crate) branch_status_loading_notice: super::types::LoadingState,
    ...
    pub(crate) fn new(
        ...
        let state = Self {
            ...
            diff: DiffState {
                ...
                diff_preview_lines: vec![Line::from(crate::ui::messages::placeholders::NO_DIFFS)],
                ...
                branch_status_auto_next_at: None,
                branch_status_loading_notice: super::types::LoadingState::default(),
                ...
                commit_preview_lines: vec![Line::from(
