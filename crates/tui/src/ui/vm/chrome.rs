...
pub(crate) fn build_top_bar(app: &AppState) -> TopBarVm {
...
pub(crate) struct BottomBarVm {
    pub(crate) line: Line<'static>,
}

pub(crate) fn build_bottom_bar(app: &AppState) -> BottomBarVm {
    ...
    let line = if let Some(toast) = app.ui.toast.as_ref() {
        Line::from(vec![
        ...
        Line::from(Span::styled(text, crate::ui::palette::chrome_hint()))
    };
